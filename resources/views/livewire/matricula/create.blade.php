...
<div class="fixed z-50 inset-0 overflow-y-auto ease-out duration-400">
    ...
    <form  class="p-4 md:p-5">
        <div>
            ...
            <div class="mb-4">
                <label for="DniBusqueda" class="block text-sm font-medium text-gray-700 dark:text-gray-300">DNI del Estudiante</label>
                <input type="text"
                       id="DniBusqueda"
                       name="DniBusqueda"
            ...
            @if ($codigoEstudiante)
            <div class="mb-4">
                <label for="CodigoEstudiante" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Código del Estudiante</label>
                <input type="text" id="CodigoEstudiante" name="CodigoEstudiante" wire:model.live.debounce.500ms="codigoEstudiante"
                    class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
            ...
            <div class="mb-4 hidden">
                <label for="estudiante_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">ID estudiante</label>
            ...
            @if ($nombreCompleto)
                <div class="mb-4">
                    <label for="nombreCompleto" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nombre del Estudiante</label>
                    <input type="text" id="nombreCompleto" name="nombreCompleto" wire:model="nombreCompleto" readonly
                        class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
