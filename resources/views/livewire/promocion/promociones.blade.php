                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <button wire:click="edit({{ $promocion->id }})"
                            class="px-3 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 rounded-lg">Editar</button>
                        <button wire:click="confirmDelete({{ $promocion->id }})"
                            class="px-3 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 rounded-lg">Eliminar</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
