                    ...
                    <td class="px-6 py-4">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" class="sr-only peer"
                                wire:click="toggleEstado({{ $estudiante->id }})"
                                {{ $estudiante->estado ? 'checked' : '' }}>
                            <div class="relative w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 
                                peer-focus:ring-4 peer-focus:ring-red-400 dark:peer-focus:ring-red-700 
            ...
            @foreach($estudiantes as $estudiante)
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400"><span class="font-bold text-md text-gray-800 dark:text-gray-300">Código: </span>{{ $estudiante->codigo }}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400"><span class="font-bold text-md text-gray-800 dark:text-gray-300">DNI:</span> {{ $estudiante->dni }}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400"><span class="font-bold text-md text-gray-800 dark:text-gray-300">Nacimiento:</span> {{ $estudiante->fecha_nacimiento }}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400"><span class="font-bold text-md text-gray-800 dark:text-gray-300">Sexo:</span> {{ $estudiante->sexo }}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400"><span class="font-bold text-md text-gray-800 dark:text-gray-300">Residencia:</span> {{ $estudiante->residencia }}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400"><span class="font-bold text-md text-gray-800 dark:text-gray-300">Teléfono:</span> {{ $estudiante->telefono }}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400"><span class="font-bold text-md text-gray-800 dark:text-gray-300">Correo:</span> {{ $estudiante->correo }}</p>
                    </div>
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estás seguro de que deseas eliminar al estudiante: "<strong>{{ $nombreAEliminar }}</strong>"? <br>Esta
