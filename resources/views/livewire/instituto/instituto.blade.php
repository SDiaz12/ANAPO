<div>
    <div>
        @if($isOpen)
            @include('livewire.instituto.create')
        @endif
        ...
        <div
                    ...
                    <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200"
                        ...
                        <li>
                            <div class="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input wire:click="loadMore({{10}})" checked="" id="filter-radio-example-2" type="radio"
                        ...
                        <li>
                            <div class="flex items-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input wire:click="loadMore({{20}})" id="filter-radio-example-3" type="radio" value=""
                                    name="filter-radio"
                                    class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <li>
                            <div class="flex rounded-lg items-center p-2 hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input wire:click="loadMore({{30}})" id="filter-radio-example-4" type="radio" value=""
                                    name="filter-radio"
                                    class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="filter-radio-example-4"
                                    class="w-full ms-2 text-sm font-medium text-gray-900 rounded-sm dark:text-gray-300">30
                                    institutos</label>
                            </div>
                        </li>
                        <li>
                            <div class="flex rounded-lg items-center p-2 hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input wire:click="loadMore({{$institutosCount}})" id="filter-radio-example-4"
            ...
            <div class="relative">
                ...
                <input wire:model.live="search" type="text" id="table-search"
                    ...
                    aria-placeholder="Buscar instituto">
            </div>
        </div>
                ...
                <tbody>
                    @foreach($institutos as $instituto)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <button wire:click="edit({{ $instituto->id }})"
                                ...
                                <button wire:click="confirmDelete({{ $instituto->id }})"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 text-center">
                            <svg class="mx-auto mb-4 animate-bounce text-red-600 w-12 h-12 dark:text-red-600"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estás seguro de que
                                deseas eliminar el instituto: "<strong>{{ $nombreAEliminar }}</strong>"? <br>Esta
                                acción no se puede deshacer.</h3>
                            <button wire:click="delete" type="button"
                                class="text-white bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:focus:ring-gray-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                Eliminar
                            </button>
                            <button wire:click="$set('confirmingDelete', false)" type="button"
