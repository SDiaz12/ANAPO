<div>
    <div class="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 bg-gray-100 dark:bg-gray-900 p-1">
        ...
        <div
            ...
            <div class="ml-5">
                ...
                <h4 class="text-2xl font-bold text-gray-900 dark:text-white">585</h4>
            </div>
        </div>
        ...
        <div
            ...
            <div class="ml-5">
                ...
                <h4 class="text-2xl font-bold text-gray-900 dark:text-white">4</h4>
            </div>
        </div>
        ...
        <div
            ...
            <div class="ml-5">
                ...
                <h4 class="text-2xl font-bold text-gray-900 dark:text-white">74</h4>
            </div>
        </div>
        ...
        <div
            ...
            <div class="ml-5">
                ...
                <h4 class="text-2xl font-bold text-gray-900 dark:text-white">15</h4>
            </div>
        </div>
        ...
        <div
            ...
            <div class="ml-5">
                ...
                <h4 class="text-2xl font-bold text-gray-900 dark:text-white">145</h4>
            </div>
        </div>
    ...
    <div class="mt-2 grid gap-4 sm:mt-2 lg:grid-cols-3 lg:grid-rows-2 p-1">
        <div class="relative lg:row-span-2">
            <div class="absolute inset-px rounded-lg border border-gray-200 bg-white  dark:border-gray-700 dark:bg-gray-800 lg:rounded-l-[2rem]"></div>
            <div
                class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                    <p class="mt-2 text-lg font-medium tracking-tight text-gray-900 dark:text-white max-lg:text-center">Mobile friendly
                    </p>
                    <p class="mt-2 max-w-lg text-sm/6 text-gray-700 dark:text-gray-400 max-lg:text-center">Anim aute id magna aliqua ad ad
                        non deserunt sunt. Qui irure qui lorem cupidatat commodo.</p>
                </div>
        ...
        <div class="relative max-lg:row-start-1">
            <div class="absolute inset-px rounded-lg border border-gray-200 bg-white  dark:border-gray-700 dark:bg-gray-800 max-lg:rounded-t-[2rem]"></div>
            <div
                class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                <div class="px-8 pt-8 sm:px-10 sm:pt-10">
                    <p class="mt-2 text-lg font-medium tracking-tight text-gray-900 dark:text-white max-lg:text-center">Resultados</p>
                    <p class="mt-2 max-w-lg text-sm/6 text-gray-700 dark:text-gray-400 max-lg:text-center">Lorem ipsum, dolor sit amet
        ...
        <div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            <div class="absolute inset-px rounded-lg border border-gray-200 bg-white  dark:border-gray-700 dark:bg-gray-800"></div>
            <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
                <div class="px-8 pt-8 sm:px-10 sm:pt-10">
                    <p class="mt-2 text-lg font-medium tracking-tight text-gray-900 dark:text-white max-lg:text-center">Security</p>
                    <p class="mt-2 max-w-lg text-sm/6 text-gray-700 dark:text-gray-400 max-lg:text-center">Morbi viverra dui mi arcu sed.
        ...
        <div class="relative lg:row-span-2">
            <div class="absolute inset-px rounded-lg border border-gray-200 bg-white  dark:border-gray-700 dark:bg-gray-800 max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]"></div>
            <div
                ...
                <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                    <p class="mt-2 text-lg font-medium tracking-tight text-gray-900 dark:text-white max-lg:text-center">Powerful APIs
                    </p>
                    <p class="mt-2 max-w-lg text-sm/6 text-gray-700 dark:text-gray-400 max-lg:text-center">Sit quis amet rutrum tellus
